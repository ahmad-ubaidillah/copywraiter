...
PLATFORM_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "threads": {
        "max_chars": 500,
        "hashtags": False,
        "emoji_policy": "discouraged",
        "formatting": "plain",
        "tone": "jujur, sarkas, relatable, bahasa warkop Indonesia",
        "structure": "Thread chain: Post 1 (Hook) → replies (lanjutan cerita/analisis)",
        "banned_patterns": ["hashtags", "emoji", "kata marketing", "bold", "engagement bait"],
        "recommended_length": "TIDAK ADA BATASAN — tulisan panjang dipisah jadi thread (replies)",
        "threading": True,
